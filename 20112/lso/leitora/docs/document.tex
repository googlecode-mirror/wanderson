...
\texttt{log} do sistema. CORBET informa que este conteúdo é enviado para o
arquivo \texttt{/var/logs/messages}, porém no sistema Debian utilizado para
desenvolver este documento o conteúdo foi enviado para
