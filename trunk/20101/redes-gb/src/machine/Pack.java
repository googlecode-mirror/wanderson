...
/**
 * Classe Pacote Informações para Envio Empacotadas
 * 
...
public class Pack implements Serializable {
	...
	/**
	 * Checagem de Pedido de desconexão
	 */
	...
	/**
	 * Informa um Início de Desconexão
	 * 
	 * @return Informação Solicitada
	 */
	...
	/**
	 * Configura a Verificação de Início de Desconexão
	 * 
	 * @param flag
	 *            Identificador de Resultado
	 */
