...
\begin{frame}{Contato}
    \begin{description}
    \item[twitter] @wandersonwhcr
    \item[email]   wandersonwhcr@gmail.com
    \item[source]  http://code.google.com/p/wanderson
    \item[site]    http://www.wanderson.camargo.nom.br/
    \end{description}
    \begin{center}
        \huge{\ldots e Feliz Dia da Toalha!}
    \end{center}
\end{frame}
